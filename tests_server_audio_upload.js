...
`]);
  ...
  try {
    ...
    assert.strictEqual(status.json.generated, 3, status.text);
    assert.strictEqual(status.json.missing, 17, status.text);
    assert.strictEqual(status.json.firstKey, 'w000001', status.text);
    assert.strictEqual(status.json.lastKey, 'w000020', status.text);
    assert.strictEqual(status.json.lastContiguousGeneratedKey, 'w000003', status.text);
    assert.strictEqual(status.json.firstMissingKey, 'w000004', status.text);
    assert.strictEqual(status.json.nextStartKey, 'w000004', status.text);
    assert.strictEqual(status.json.nextEndKey, 'w000013', status.text);
    assert.deepStrictEqual(status.json.nextMissingKeys, ['w000004', 'w000005', 'w000006', 'w000007', 'w000008', 'w000009', 'w000010', 'w000011', 'w000012', 'w000013'], status.text);
